...
export default function Services() {
  ...
  return (
    <div className="min-h-screen bg-light-bg dark:bg-dark-bg transition-colors duration-300">
                ...
                <div className="space-y-2">
                  {service.features.map((feature, idx) => (
                    <div key={idx} className="flex items-start gap-2">
                      ...
                      <span className="text-sm text-light-textSecondary dark:text-dark-textSecondary">{feature}</span>
                    </div>
                  ))}
                </div>
              </div>
      ...
      {/* CTA Section */}
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center card bg-gradient-to-br from-primary-500/20 to-transparent border-primary-500/30">
