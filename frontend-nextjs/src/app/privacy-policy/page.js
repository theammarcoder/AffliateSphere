        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <section className="card">
            ...
            <div className="space-y-4 text-light-textSecondary dark:text-dark-textSecondary">
              <div>
                <h3 className="text-lg font-semibold text-light-text dark:text-dark-text mb-2">Personal Information</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-light-text dark:text-dark-text mb-2">Automatically Collected Information</h3>
                <p className="leading-relaxed">
          ...
          <section className="card">
            ...
            <div className="text-light-textSecondary dark:text-dark-textSecondary space-y-3">
              <p className="leading-relaxed">
